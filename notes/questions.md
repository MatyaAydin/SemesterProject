...
* Hyperparameter optimization: optuna ? how many layers, neighbors, hidden size, kernel size, activation functions: no more than two graph layers, temporal: 1, 3, 5, hidden size: power of two: 16, 32, 64, k = 4 (optuna)
