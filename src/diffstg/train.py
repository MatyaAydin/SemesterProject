...
def get_params():
    ...
    parser.add_argument("--graph_method", type=str, default='fixed') # fixed, learnable, learnable_static, dagg, dagg_I, learnable_nucleus
...
def default_config(data='AIR_BJ'):
    config = edict() # EasyDict is a dictionary that allows for dot notation access to its keys
